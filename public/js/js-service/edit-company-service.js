(function ($) {
    ...
    $('.form-benefit').append($('.benefit-add').html());
    ...
    $('#update-company').on('click',function () {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#update-company').removeAttr("disabled");
                setTimeout(function () {
                    toastr.options = {
                        closeButton: true,
                        progressBar: true,
                    ...
                    toastr.success('', 'Update công ty thành công');
                }, 500);
                setTimeout(function () {
            ...
            error: function (data) {
                ...
                setTimeout(function () {
                    ...
                    toastr.error('', 'Update công ty thất bại ');
                }, 500);
