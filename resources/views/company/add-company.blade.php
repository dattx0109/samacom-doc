    ...
    <div class="add-new-page-container animated fadeInRight">
        <div class="single-info-page dashboard-page">
            ...
            <div class="dashboard-page-container">
                <form method="post" id="upload_form"  action="{{route('company-store')}}" class="form-horizontal" enctype="multipart/form-data">
...
@section('javascript-bottom')
    ...
    <script src="{{asset('/js/js-service/add-company-service.js')}}"></script>
